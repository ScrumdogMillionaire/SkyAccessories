    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(max_digits=14, decimal_places=2)),
                ('product_image', models.ImageField(storage=django.core.files.storage.FileSystemStorage(location=b'/Users/mpa45/SkyAccessories/Website/sky/static/'), null=True, upload_to=b'/static/media/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('status', models.CharField(default=b'not_ordered', max_length=20, null=True, choices=[(b'not_ordered', b'not_ordered'), (b'ordered', b'ordered'), (b'removed', b'removed')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(related_name='user_reward', null=True, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'rewards',
            },
